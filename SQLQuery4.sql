...
insert into Salesman values(01,'priya','pune',500);
insert into Salesman values(02,'priyanka','mumbai',1000);
select *from Salesman;

insert into MyCustomer values(10,'John','Mumbai',01);
insert into MyCustomer values(20,'sam','Nagpur',02);

select *from MyCustomer;

select CName,City,Commision from Salesman INNER JOIN MyCustomer ON Salesman.City=MyCustomer.CCity;

select MyCustomer.CName,MyCustomer.CCity,Salesman.Name,Salesman.Commision 
from Salesman INNER JOIN MyCustomer on Salesman.City=MyCustomer.CCity;
)
...
INSERT INTO My_ORDERS VALUES('200100', '1000.00', '600.00', '08/01/2008', 'C00013', 'A003', 'SOD');
INSERT INTO My_ORDERS VALUES('200110', '3000.00', '500.00', '04/15/2008', 'C00019', 'A010', 'SOD');
INSERT INTO My_ORDERS VALUES('200107', '4500.00', '900.00', '08/30/2008', 'C00007', 'A010', 'SOD');
INSERT INTO My_ORDERS VALUES('200112', '2000.00', '400.00', '05/30/2008', 'C00016', 'A007', 'SOD'); 
INSERT INTO My_ORDERS VALUES('200113', '4000.00', '600.00', '06/10/2008', 'C00022', 'A002', 'SOD');
INSERT INTO My_ORDERS VALUES('200102', '2000.00', '300.00', '05/25/2008', 'C00012', 'A012', 'SOD');
INSERT INTO My_ORDERS VALUES('200114', '3500.00', '2000.00', '08/15/2008', 'C00002', 'A008', 'SOD');
INSERT INTO My_ORDERS VALUES('200122', '2500.00', '400.00', '09/16/2008', 'C00003', 'A004', 'SOD');
INSERT INTO My_ORDERS VALUES('200118', '500.00', '100.00', '07/20/2008', 'C00023', 'A006', 'SOD');
INSERT INTO My_ORDERS VALUES('200119', '4000.00', '700.00', '09/16/2008', 'C00007', 'A010', 'SOD');
INSERT INTO My_ORDERS VALUES('200121', '1500.00', '600.00', '09/23/2008', 'C00008', 'A004', 'SOD');
INSERT INTO My_ORDERS VALUES('200130', '2500.00', '400.00', '07/30/2008', 'C00025', 'A011', 'SOD');
INSERT INTO My_ORDERS VALUES('200134', '4200.00', '1800.00', '09/25/2008', 'C00004', 'A005', 'SOD');
INSERT INTO My_ORDERS VALUES('200108', '4000.00', '600.00', '02/15/2008', 'C00008', 'A004', 'SOD');
INSERT INTO My_ORDERS VALUES('200103', '1500.00', '700.00', '05/15/2008', 'C00021', 'A005', 'SOD');


select * from My_ORDERS;

select * from AGENTS where AGENT_CODE in(select AGENT_CODE from CUSTOMER where CUSTOMER.CUST_NAME='Martin');

select * from AGENTS where AGENT_CODE in(select AGENT_CODE from CUSTOMER where CUSTOMER.CUST_CITY='Mumbai');

select * from AGENTS where AGENT_CODE in(select AGENT_CODE from CUSTOMER where CUSTOMER.CUST_NAME='Albert');
...
create procedure 
SUBQUERY_ON_MyAGENTS
AS
SELECT *from CUSTOMER
where CUSTOMER.PHONE_NO='077-25814763';
go
EXEC SUBQUERY_ON_MyAGENTS;


create procedure
myprocedure
as
select *from AGENTS INNER JOIN CUSTOMER on AGENTS.AGENT_CODE=CUSTOMER.AGENT_CODE;
go
exec myprocedure;

create procedure myprocedures2 @WORKING_AREA CHAR(35)   ------using variables--------
as
select *from AGENTS where WORKING_AREA=@WORKING_AREA;
go

exec myprocedures2 @WORKING_AREA='London';

select * from AGENTS where WORKING_AREA='London';

select * from AGENTS 
where WORKING_AREA='London' OR COMMISSION='0.14';     ------using OR 

select * from AGENTS                                  ------using AND 
where WORKING_AREA='London' AND COMMISSION='0.15';


-----using 2 variables------

create procedure 
storedProcedure @CAREA CHAR(35) @CCOM DECIMAL(10,2)
as
select * from AGENTS where WORKING_AREA = @CAREA AND COMMISSION = @CCOM;
go


create procedure Display_AGENTS
as
select * from AGENTS;
